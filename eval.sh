...
# Resnet + CCNet + ADE20K
python evaluate.py --num-classes 150 --datasets ade --data-dir ../datasets/ADEChallengeData2016 --data-list ./dataset/list/ade20k/ade20k_val.txt --recurrence 2 --model ccnet --restore-from ./snapshots/ADE20k_15000ccnet.pkl --gpu 0 --batch-size 1 >../log/eval_resnet_ADE_15000_size600_retest.log
