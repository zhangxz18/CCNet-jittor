...
# VAN + CCNet + ADE20K
# python train.py --num-classes 150 --datasets ade --data-dir ../datasets/ADEChallengeData2016 --random-mirror --random-scale --restore-from ./dataset/van_b1.pth --data-list ./dataset/list/ade20k/ade20k_train.txt --gpu 4 --learning-rate 0.01 --input-size 600,600 --weight-decay 0.0001 --batch-size 1 --num-steps 60000 --recurrence 2 --ohem 1 --ohem-thres 0.7 --ohem-keep 100000 --model van --need_crop > ../log/train_van_ADE_b1.log