...
# Resnet + CCNet + ADE20K
# mpirun -np 4 python train.py --num-classes 150 --datasets ade --data-dir ../datasets/ADEChallengeData2016 --random-mirror --restore-from ./dataset/resnet101-imagenet.pth --data-list ./dataset/list/ade20k/ade20k_train.txt --gpu 0,1,2,3 --learning-rate 0.01 --input-size 512,512 --weight-decay 0.0001 --batch-size 4 --num-steps 80000 --save-pred-every 5000 --recurrence 2 --ohem 1 --ohem-thres 0.7 --ohem-keep 100000 --model ccnet --need_crop --batch_per_gpu 2 >../log/train_resnet_ADE_b8_8w.log
...
# VAN + CCNet + ADE20K
mpirun -np 4 python train.py --num-classes 150 --datasets ade --data-dir ../datasets/ADEChallengeData2016 --random-mirror --random-scale --restore-from ./dataset/van_b2.pth --data-list ./dataset/list/ade20k/ade20k_train.txt --gpu 0,1,2,3 --learning-rate 0.01 --input-size 512,512 --weight-decay 0.0001 --batch-size 4 --num-steps 80000 --save-pred-every 5000 --recurrence 2 --ohem 1 --ohem-thres 0.7 --ohem-keep 100000 --model van --need_crop --batch_per_gpu 2 > ../log/train_van_ADE_batchsize8_iter8k.log